...
router.post('/permutas', somenteAdmin, ctl.criarPermutaAdmin);
router.delete('/permutas/:permutaId', somenteAdmin, ctl.excluirPermutaAdmin);
...
router.get('/:id/base-plantoes-permuta', somenteAdmin, ctl.listarPlantoesBasePermuta);
